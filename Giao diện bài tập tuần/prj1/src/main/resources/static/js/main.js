...
buttonWeek.forEach(element=>element.addEventListener("click",(e)=>{
	for(var l of buttonWeek){
        if(l.classList.contains("active-topic-week-main")){
            l.classList.remove("active-topic-week-main")
        }
    }
    e.target.classList.add("active-topic-week-main");
...
function handleExercise(data){
	for(var i of buttonClass){
        i.classList.contains("active-topic-class");
        i.classList.remove("active-topic-class")
    }
    data.target.classList.add("active-topic-class");
