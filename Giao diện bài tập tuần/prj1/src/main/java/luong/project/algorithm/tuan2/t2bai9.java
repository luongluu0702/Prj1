package luong.project.algorithm.tuan2;

import luong.project.entity.Exercise;
import java.util.*;
import java.util.stream.Collectors;

public class t2bai9 extends Exercise {

    public t2bai9(){
        this.setTitle("Cho một dãy số nguyên bất kỳ, cho trước 1 số c. Hãy đếm có bao nhiêu số của"+
                "dãy trên =c; >c; <c.");
